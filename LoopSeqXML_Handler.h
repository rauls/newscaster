...
{                               // state machine
	...
	IMPRESSION_REFERAL,
	IMPRESSION_IMAGEDIR,
	IMPRESSION_IMAGEFILTER,
	IMPRESSION_MULTIMEDIA,
	IMPRESSION_MULTIMEDIADIR,
	IMPRESSION_MULTIMEDIAURL,
	IMPRESSION_URLPARAMS,
	IMPRESSION_PRINT,
	IMPRESSION_VOICE,
...
public:
	virtual ImpressionData *GetCurrentImpressionPtr( void ) { return &currentImpression; };
    void InitCurrentImpression(int id);       // See C++ implementation
