...
//	SetPriorityClass( GetCurrentProcess(), REALTIME_PRIORITY_CLASS );
	...
	if( cfgFontHeight == 0 || cfgBarHeight == 0 )
	{
	...
	GETINI_STRING( cfgLocalBaseDir, "LOCAL MACHINE", "LocalBaseDir", "C:\\Widgie.Application\\" );
	// check if base dir exists, other wise default to current dir...
	{
		struct stat sbuf;
	...
	GETINI_STRING( cfgDownloadIntervalTime, "DOWNLOAD", "MediaDownloadIntervalTime", "02:00:00" );
	...
	// --- SERVER
	GETINI_STRING( cfgIPandPort, "SERVER", "IPandPort", "signserver" );
...
BOOL CWidgieApp::OpenSplashLogo( void )
{
	...
	OutDebugs( "Showing openin screen..." );
	int showResult;
...
int CWidgieApp::PrintTextLarge(char *text)
{
	...
	if( textDC && textDC->m_hDC )
	{
		...
		RECT rc = { 0,150, cfgRight, cfgBottom };
