...
int NewsDialog::ShowNextCaption(void)
{
    ...
    {            
        ...
        RECT nfRect;
        nfRect.bottom = CFG->cfgBottom;
        nfRect.left = 0;
        nfRect.right = CFG->cfgRight;
        nfRect.top = 0;
...
void NewsDialog::StopTimers(void)
{
	...
	if( newsflash1 )
		newsflash1->textPosition = CFG->cfgRight + 10;
...
void NewsDialog::ShowDialog( BOOL showLogo )
{
	...
	MoveWindow( CFG->cfgLeft,  CFG->cfgBottom-CFG->cfgBarHeight,
		        CFG->cfgRight, CFG->cfgBarHeight, FALSE );
